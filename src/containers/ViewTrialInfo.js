                        ...
                        <div class="col-3">
                            <div class="nav flex-column nav-tabs border-0" style={{ "marginTop": "6px" }} id="v-pills-tab" role="tablist"
                                ...
                                <a class="nav-link p-3" id="v-pills-add-user-tab" data-toggle="pill" href="#v-pills-profile"
                                    role="tab" aria-controls="v-pills-profile" aria-selected="false"><i class="fa fa-medkit text-secondary" aria-hidden="true"></i>
                                ...
                                <a class="nav-link p-3" id="v-pills-add-user-tab" data-toggle="pill"
                                    ...
                                    aria-selected="false" ><i class="fa fa-ambulance text-secondary" aria-hidden="true" ></i><strong className="text-secondary">&nbsp;Diseases</strong></a>
                            </div>
                        </div>
                        <div class="col-9">
                                        ...
                                        <div className="card">
                                            <div className="card-header">
                                                <h1 className='text-center font-weight-bold'
                                                    style={{ "color": "#2994b2" }}><span className="font-weight-bold">Title</span>
                                                </h1>
                                            </div>
