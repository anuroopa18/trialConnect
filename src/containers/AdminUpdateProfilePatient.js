                            ...
                            <div className="card">
                                ...
                                <div class="card-body p-0">
                                    <div className='text-center card-img-top mt-3'>
                                        <img className="center" src={icon} width="60" height="60" alt="icon"/>
                                    </div>
                                    <div>
                                        ...
                                        <input required type="text" className="form-control" name="firstName"
                                               ...
                                               onChange={() => {
                                                   this.props.firstNameUpdateAdminPat(firstNameInput.value)
                                    ...
                                    <div>
                                        ...
                                        <input required className="form-control" name="age"
                                    ...
                                    <div>
                                        ...
                                        <input required className="form-control" name="gender"
                                    ...
                                    <div>
                                        ...
                                        <input required className="form-control" name="height"
                                    ...
                                    <div>
                                        ...
                                        <input required className="form-control" name="weight"
